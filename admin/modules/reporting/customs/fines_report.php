...
<?php
    ...
    while ($_fines_d = $_fines_q->fetch_row()) {
        ...
        $fines_data[$date] = '<div class="data"><a href="'.AWB.'modules/reporting/customs/member_fines_list.php?reportView=true&finesDate='.$selected_year.'-'.$selected_month.'-'.$date.'" class="notAJAX openPopUp" width="800" height="600">'.($_fines_d[1]?$_fines_d[1]:'0').'</a></div>';
    }
