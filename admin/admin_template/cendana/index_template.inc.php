...
<link href="<?php echo AWB; ?>admin_template/<?php echo $sysconf['admin_template']['theme']?>/jquery.sidr.light.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?php echo AWB; ?>admin_template/<?php echo $sysconf['admin_template']['theme']?>/jquery.sidr.min.js"></script>
