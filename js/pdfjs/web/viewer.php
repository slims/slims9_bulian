    ...
    <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
            <div id="secondaryToolbarButtonContainer">
                ...
                <button id="secondaryPrint" class="secondaryToolbarButton print visibleMediumView <?php if(!$sysconf['allow_file_download']) echo 'hidden'; ?>" title="Print"
                        tabindex="53" data-l10n-id="print">
                    <span data-l10n-id="print_label">Print</span>
                </button>

                <button id="secondaryDownload" class="secondaryToolbarButton download visibleMediumView <?php if(!$sysconf['allow_file_download']) echo 'hidden'; ?>"
            ...
            <div id="toolbarContainer">
                <div id="toolbarViewer">
                    ...
                    <div id="toolbarViewerRight">
                        ...
                        <button id="print" class="toolbarButton print hiddenMediumView <?php if(!$sysconf['allow_file_download']) echo 'hidden'; ?>" title="Print" tabindex="33"
                                data-l10n-id="print">
                            <span data-l10n-id="print_label">Print</span>
                        </button>

                        <button id="download" class="toolbarButton download hiddenMediumView <?php if(!$sysconf['allow_file_download']) echo 'hidden'; ?>" title="Download"
