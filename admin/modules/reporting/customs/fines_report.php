...
<?php
    ...
    // print out
    echo '<div class="printPageInfo">Fines Count Report for <strong>'.$months[$selected_month].', '.$selected_year.'</strong> <a class="s-btn btn btn-default printReport" onclick="window.print()" href="#">'.__('Print Current Page').'</a></div>'."\n";
    echo $output;
