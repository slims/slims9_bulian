 ...
 * @File name           : install_sample_data.sql.php
 */

$sample_sql = [];
$sample_sql['insert'][] = 'INSERT IGNORE INTO `biblio` (`biblio_id`, `gmd_id`, `title`, `edition`, `isbn_issn`, `publisher_id`, `publish_year`, `collation`, `series_title`, `call_number`, `language_id`, `source`, `publish_place_id`, `classification`, `notes`, `image`, `file_att`, `opac_hide`, `promoted`, `input_date`, `last_update`) VALUES
...
$sample_sql['insert'][] = 'INSERT IGNORE INTO `biblio_author` (`biblio_id`, `author_id`, `level`) VALUES
(1, 1, 1),
(2, 2, 1),
(2, 3, 2),
(2, 4, 2),
...
$sample_sql['insert'][] = 'INSERT IGNORE INTO `biblio_topic` (`biblio_id`, `topic_id`, `level`) VALUES
(1, 1, 1),
(1, 2, 2),
(2, 3, 1),
(2, 4, 2),
...
$sample_sql['insert'][] = 'INSERT IGNORE INTO `item` (`item_id`, `biblio_id`, `coll_type_id`, `item_code`, `inventory_code`, `received_date`, `supplier_id`, `order_no`, `location_id`, `order_date`, `item_status_id`, `site`, `source`, `invoice`, `price`, `price_currency`, `invoice_date`, `input_date`, `last_update`) VALUES
(1, 8, 1, \'B00001\', \'INV/B00001\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 1, \'\', 500000, \'Rupiah\', \'2007-11-29\', \'2008-12-26 22:11:10\', \'2008-12-26 22:14:13\'),
(2, 6, 1, \'B00002\', \'INV/B00002\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 1, \'\', 700000, \'Rupiah\', \'2007-11-29\', \'2008-12-26 22:11:45\', \'2008-12-26 22:13:45\'),
(3, 15, 1, \'B00003\', \'INV/B00003\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 1, \'\', 300000, \'Rupiah\', \'2007-11-29\', \'2008-12-26 22:15:09\', \'2008-12-26 22:15:09\'),
(4, 14, 1, \'B00004\', \'INV/B00004\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 1, \'\', 250000, \'Rupiah\', \'2007-11-29\', \'2008-12-26 22:15:49\', \'2008-12-26 22:15:49\'),
(5, 13, 1, \'B00005\', \'INV/B00005\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 2, \'\', 0, NULL, \'2007-11-29\', \'2008-12-26 22:17:04\', \'2008-12-26 22:17:04\'),
(6, 12, 1, \'B00006\', \'INV/B00006\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 1, \'\', 350000, \'Rupiah\', \'2007-11-29\', \'2008-12-26 22:17:52\', \'2008-12-26 22:17:52\'),
(7, 4, 1, \'B00007\', \'INV/B00007\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 1, \'\', 450000, \'Rupiah\', \'2007-11-29\', \'2008-12-26 22:18:29\', \'2008-12-26 22:18:29\'),
(8, 4, 1, \'B00008\', \'INV/B00008\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 2, \'\', 0, NULL, \'2007-11-29\', \'2008-12-26 22:18:51\', \'2008-12-26 22:18:51\'),
(9, 2, 1, \'B00009\', \'INV/B00009\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 1, \'\', 630000, \'Rupiah\', \'2007-11-29\', \'2008-12-26 22:19:28\', \'2008-12-26 22:19:28\'),
(10, 2, 1, \'B00010\', \'INV/B00010\', \'2007-11-29\', \'0\', \'\', \'SL\', \'2007-11-29\', \'0\', \'\', 1, \'\', 630000, \'Rupiah\', \'2007-11-29\', \'2008-12-26 22:19:57\', \'2008-12-26 22:19:57\');';

$sample_sql['insert'][] = 'INSERT IGNORE INTO `mst_author` (`author_id`, `author_name`, `authority_type`, `input_date`, `last_update`) VALUES
...
$sample_sql['insert'][] = 'INSERT IGNORE INTO `mst_place` VALUES
...
$sample_sql['insert'][] = 'INSERT IGNORE INTO `mst_publisher` (`publisher_id`, `publisher_name`, `input_date`, `last_update`) VALUES
...
$sample_sql['insert'][] = 'INSERT IGNORE INTO `mst_topic` (`topic_id`, `topic`, `input_date`, `last_update`) VALUES
