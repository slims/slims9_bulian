 ...
 */
$setBookmarked = trim(isset($_SESSION['bookmark'][$biblio_id]) ? 'bg-success text-white rounded-lg px-2 py-1' : 'text-secondary');
?>
    ...
    <div class="flex flex-wrap">
        <div class="w-64 mb-2">
            ...
            <div class="d-flex flex-row justify-content-center text-sm my-3">
                <a href="#" data-id="<?= $biblio_id ?>" class="bookMarkBook text-decoration-none <?= $setBookmarked ?> font-weight-bolder mr-3">
