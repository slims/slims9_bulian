 ...
 * @create date 2022-11-01 10:16:33
 * @modify date 2022-11-03 10:00:36
 * @license GPLv3
 * @desc [description]
 */
...
class Sftp extends Contract
{
     ...
     * @param string $root
     */
    public function __construct(array $connectionProvider, string $rootPath, array $visibilityProvider)
    {
        $this->adapter = new SftpAdapter(
            new SftpConnectionProvider(...$connectionProvider),
            $rootPath,
            PortableVisibilityConverter::fromArray($visibilityProvider)
        );
